...
mvb_plot %>% dplyr::filter(period == "2010~2014年") %>% 
...
mvb_plot %>% dplyr::filter(period == "2015~2019年") %>% 
  group_sort(location,province,mar) %>% pull(1) -> lev
